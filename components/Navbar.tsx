          ...
          <svg width="55" height="55" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip_nav_logo)">
              ...
              <path 
                fillRule="evenodd" 
                clipRule="evenodd" 
                d="M17.6661 14.3535C17.8723 14.4363 17.9781 14.5911 17.986 14.8127C17.8909 15.3467 17.8644 15.8807 17.9067 16.4174C18.0257 16.7084 18.1923 16.962 18.4118 17.175C17.9332 17.504 17.7216 17.9632 17.7772 18.5559C17.7798 23.9839 17.7798 29.4144 17.7798 34.8424C17.7348 35.2909 18.2478 35.953 17.5815 36.1025C17.4466 35.5125 17.3832 34.9144 17.3884 34.3084C17.399 28.0768 17.3937 21.8479 17.3699 15.6164C17.3435 15.1625 17.4413 14.7407 17.6661 14.3535Z" 
                fill="#CBAA4C"
              />
              <path 
                fillRule="evenodd" 
