...
export default function Navbar() {
  ...
  return (
    <header className="w-full max-w-[1435px] mx-auto px-4 md:px-[64px] h-[72px] flex justify-between items-center relative z-50 font-sans bg-white border-b border-black/10 text-[#0D0B05]">
      {/* Brand Logo & Name */}
          ...
          <svg width="55" height="55" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip_nav_logo)">
              ...
              <path 
                ...
                className="fill-black group-hover:fill-[#CBAA4C] stroke-black group-hover:stroke-[#FED55F] transition-colors duration-300"
                strokeWidth="0.5"
              />
              ...
              <path 
                ...
                className="fill-black group-hover:fill-[#CBAA4C] transition-colors duration-300"
              />
              <path 
                fillRule="evenodd" 
                clipRule="evenodd" 
