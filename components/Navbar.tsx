...
export default function Navbar({ theme = "light" }: NavbarProps) {
  ...
  const themeClasses = {
    light: {
      ...
      logoPath1: "fill-[#CBAA4C] group-hover:fill-black stroke-[#FED55F] group-hover:stroke-black transition-colors duration-300",
      logoPath2: "fill-[#CBAA4C] group-hover:fill-black transition-colors duration-300",
      logoPath3: "fill-[#CBAA4C] group-hover:fill-black transition-colors duration-300",
    },
    dark: {
      ...
      logoPath1: "fill-[#CBAA4C] group-hover:fill-white stroke-[#FED55F] group-hover:stroke-white transition-colors duration-300",
      logoPath2: "fill-[#CBAA4C] group-hover:fill-white transition-colors duration-300",
      logoPath3: "fill-[#CBAA4C] group-hover:fill-white transition-colors duration-300",
    },
  };
          ...
          <svg width="55" height="55" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip_nav_logo)">
              <path 
                ...
                className={activeTheme.logoPath1}
                strokeWidth="0.5"
              />
              <path 
                fillRule="evenodd" 
                ...
                className={activeTheme.logoPath2}
              />
              <path 
                fillRule="evenodd" 
                clipRule="evenodd" 
                ...
                className={activeTheme.logoPath3}
              />
            </g>
            <defs>
